				...
				<div class="span6" style="border-right: 1px solid silver">
					...
					<div class="row center-xs" style="margin-top:50px;">
						<div class="col-xs-12">
							...
							<br />
							<br />
							<input type="text" name="ent_login" style="height:30px;width:300px" placeholder="Логин" required>
							<hr style="border-radius: 110px; width: 400px">
							<input type="password" name="ent_pass" style="height:30px;width:300px" placeholder="Пароль" required>
							<br />
							<button class="btn btn-large btn-primary" type="submit" style="margin-top:10px">Авторизоваться</button>
						</div>
					</div> <!--!, $, #, %-->
				</div>
...
<form action="/pages/services/profile/authme.php" id="regForm" method="get">
				...
				Введите свой логин:
							<a href="#" data-toggle="tooltip"  data-placement="right" title="Латинские буквы и цифры">
								<input type="text" name="reg_login" oninput="validateLogin(this)" style="height:30px;width:250px" placeholder="Логин" required>
							</a><br />
				Введите свой пароль:
							<a href="#" data-toggle="tooltip" data-placement="right" title="Должен быть больше 5 символов">
								<input type="password" name="reg_pass" oninput="validatePassword1(this)" style="height:30px;width:250px" placeholder="Пароль" required>
							</a><br />
				Подтвердите свой пароль:
							<a href="#" data-toggle="tooltip" data-placement="right" title="Пароли должны совпадать">
								<input type="password" name="ins_pass" oninput="validatePassword2(this)" style="height:30px;width:250px" placeholder="Подтверждение пароля" required>
							</a><br />
				...
				Введите свою почту:
							...
							<br/>
							<button type="submit" class="btn btn-large btn-primary" style="margin-top:10px">Зарегестрироваться</button>
						</div>
					</div>
				</div>
			</div>
