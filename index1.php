...
<img src="assets/img/head.png" style="position: relative; bottom: 80px;width: 100%;">
...
<div class="sub-head">
    <div class="menu">
        ...
        <a href="#" >
            <img src="/assets/img/stand/1.png" width="19%" height="55%"
        ...
        <a href="/polygraphy" >
            <img src="/assets/img/stand/3.png" width="19%" height="55%"
        ...
        <a href="/suveniry" >
            <img src="/assets/img/stand/4.png" width="19%" height="55%"
        ...
        <a href="/sayty" >
            <img src="/assets/img/stand/2.png" width="19%" height="55%"
        ...
        <a href="/naruzhnaya_reklama" >
            <img src="/assets/img/stand/5.png" width="19%" height="55%"
        ...
        <a href="/promo_aktsii" >
            <img src="/assets/img/stand/6.png" width="19%" height="55%"
        ...
        <a href="/transport" >
            <img src="/assets/img/stand/7.png" width="19%" height="55%"
        ...
        <a href="/media_reklama" >
            <img src="/assets/img/stand/8.png" width="19%" height="55%"
        ...
        <a href="/dizayn" >
            <img src="/assets/img/stand/9.png" width="19%" height="55%"
        ...
        <a href="/nestandartnaya_reklama" >
            <img src="/assets/img/stand/10.png" width="19%" height="55%"
...
<div id="contentHome">
    <div class="aboutUsHome">
        ...
        <p>
        <ul>
            <li><img src="/assets/img/home/01-05.png" /><span>Мы профессионалы своего дела</span></li>
            <li><img src="/assets/img/home/01-02.png" /><span>Мы дорожим каждым клиентом</span></li>
            <li><img src="/assets/img/home/01-04.png" /><span>Мы качественно и быстро выполняем свою работу</span></li>
            <li><img src="/assets/img/home/01-03.png" /><span>Мы несем ответственность за свою работу</span></li>
            <li><img src="/assets/img/home/01-01.png" /><span>У нас всегда есть свежие идеи для вашего бизнеса</span></li>
        </ul>
        </p>
    </div>
    <div class="newsHome">
    ...
    <link rel="stylesheet" type="text/css" href="assets/css-styles/component.css" />
    <div class="container">
...
<div id="portfolioHome">
    ...
    <div class="supmain">
        <img width="338" height="188" src="/assets/img/home/portfolio01.jpg" />
        <img width="338" height="188" src="/assets/img/home/portfolio02.jpg" />
        <img width="338" height="188" src="/assets/img/home/portfolio04.jpg" />
        <img width="338" height="188" src="/assets/img/home/portfolio06.jpg" />
        <img width="338" height="188" src="/assets/img/home/portfolio05.jpg" />
        <img width="338" height="188" src="/assets/img/home/portfolio03.jpg" />
    </div>
</div>
<div id="portfolioHome">
    <div class="hr-port2">
